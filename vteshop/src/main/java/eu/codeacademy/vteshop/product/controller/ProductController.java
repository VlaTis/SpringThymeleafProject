...
public class ProductController {
    ...
    public String openCreateProductForm(Model model) {
        ...
        model.addAttribute("categoryDto", ProductCategoryDto.builder().build());
        model.addAttribute("operationStationDto", OperationStationDto.builder().build());
        model.addAttribute("productStatusDto", ProductStatusDto.builder().build());
